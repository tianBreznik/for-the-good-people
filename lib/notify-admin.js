...
async function sendAuthorApplicationNotification({ name, email, message }) {
    ...
    const to = envValue('ADMIN_NOTIFY_EMAIL');
    ...
    console.log(`[mail] Sent author application notification → ${to} (from ${from}, id ${info.messageId || 'n/a'})`);
